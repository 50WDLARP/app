...
class SonicView: UIView {
    ...
    var myContainer : ConnectedViewController!
    ...
    @IBAction func sendChar(sender: UIButton) {
        ...
        myContainer.connectedBean!.sendSerialString("morse: " + morse_code)
    }
    ...
    @IBAction func colorChoice(sender: UISegmentedControl) {
        ...
        myContainer.connectedBean!.sendSerialString(color_string)
    }
